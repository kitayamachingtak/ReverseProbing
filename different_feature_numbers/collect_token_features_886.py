#!/usr/bin/env python3
#Token-level feature collection (886-feature configuration, 70B models).
#Same feature set as the 454-feature configuration, scaled to a 80-layer, 64-head model. 

import os
os.environ["HF_HOME"] = "/blue/daisyw/xiaobushi/huggingface"
...
CONFIG = {
    ...
    'gen_model_name': '/blue/daisyw/xiaobushi/huggingface/models--meta-llama--Llama-3.1-70B-Instruct/snapshots/1605565b47bb9346c5515c34102e054115b4f98b',
    ...
    'neighbor_windows': [2, 3, 5, 7, 9],
    'top_k_values': [5, 10, 20],

    'target_layers': list(range(0, 80)),
    'attention_layers': list(range(0, 80)),
    'drift_heads': [0, 16, 32, 48],
    'rollout_checkpoints': {9, 19, 29, 39, 49, 59, 69, 79},
...
def extract_all_token_features_single_forward(
    ...
    for i in range(len(summary_token_ids)):
        ...
        for l1 in range(num_layers - 1):
            l2 = l1 + 1
            if actual_idx < hidden_states_with[l1].shape[1]:
        ...
        if attentions_with:
            ...
            rollout_checkpoints = CONFIG['rollout_checkpoints']
