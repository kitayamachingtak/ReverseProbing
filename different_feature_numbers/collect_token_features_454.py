#!/usr/bin/env python3
#Token-level feature collection (454-feature configuration, 7B/8B models).
...
CONFIG = {
    ...
    'gen_model_name': 'BioMistral/BioMistral-7B',
    ...
    'attention_layers': list(range(0, 32)),
    'drift_heads': [0, 8, 16, 24],
    'rollout_checkpoints': {3, 7, 11, 15, 19, 23, 27, 31},
